...
class SpatialHash {
  ...
  _getBuckets(gob) {
    let l = Math.floor((gob._position.x - gob.width / 2) / this.tileSize),
        r = Math.floor((gob._position.x + gob.width / 2) / this.tileSize),
        t = Math.floor((gob._position.y - gob.height / 2) / this.tileSize),
        b = Math.floor((gob._position.y + gob.height / 2) / this.tileSize)
