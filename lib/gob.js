...
class Gob {
  ...
  constructor(game, opts) {
    ...
    if (opts.position) {
      ...
      if (opts.width && opts.height) {
        ...
        // this._absoluteVertices.push(this._aabb.tl)
        // this._absoluteVertices.push(this._aabb.bl)
        // this._absoluteVertices.push(this._aabb.tr)
        // this._absoluteVertices.push(this._aabb.br)
        // this._edges.push(Vector2.Subtract(this._aabb.tl, this._aabb.tr))
        // this._edges.push(Vector2.Subtract(this._aabb.tr, this._aabb.br))
        // this._edges.push(Vector2.Subtract(this._aabb.br, this._aabb.bl))
        // this._edges.push(Vector2.Subtract(this._aabb.bl, this._aabb.tl))
      }
  ...
  changeAbsoluteVertices(vertices) {
    ...
    this._edges = vertices.map(function(vertex, index) {
      console.log((index + 1) % (vertices.length), vertices[(index + 1) % vertices.length].x, vertex.x)
    ...
    console.log(this._absoluteVertices, this._normals, this._edges)
  }
