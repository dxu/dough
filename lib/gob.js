...
export default class Gob {
  ...
  __init(game: Pool, opts: GobOptions) {
    ...
    if (this.rigidbody) {
      ...
      this.rigidbody.friction = this.rigidbody.friction || 0;
      this.rigidbody.frictionAir = this.rigidbody.frictionAir || 0;
      this.rigidbody.frictionStatic = this.rigidbody.frictionStatic || 0;
      this.rigidbody.restitution = this.rigidbody.restitution || 0;
      this.rigidbody.velocity = this.rigidbody.velocity || new Vector2(0, 0);
      this.rigidbody.angularVelocity = this.rigidbody.angularVelocity || 0;
      this.rigidbody.maxVelocity =
        this.rigidbody.maxVelocity || new Vector2(Infinity, Infinity);
      this.rigidbody.maxAngularVelocity =
        this.rigidbody.maxAngularVelocity || Infinity;
    }
  ...
  __updateSprite(): void {
    ...
    this.sprite.pixi.scale.set(
      this.sprite.width / this.sprite.pixi.width * this.sprite.scale.x,
      this.sprite.height / this.sprite.pixi.height * this.sprite.scale.x,
    );
  }
  ...
  _debug(): void {
    ...
    this._debugData.spriteOutline.drawRect(
      this.transform.position.x - this.sprite.width / 2,
      this.transform.position.y - this.sprite.height / 2,
      this.sprite.width,
      this.sprite.height,
    );
