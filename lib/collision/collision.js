...
function adjustPhysicsVelocityNoTrig(gob1, gob2, normal) {
  ...
  const newVelocityNormal1 = Vector2.Multiply(unitNormal, newv1n)
  const newVelocityNormal2 = Vector2.Multiply(unitNormal, newv2n)

  const newVelocityTangent1 = Vector2.Multiply(unitTangent, v1t)
  const newVelocityTangent2 = Vector2.Multiply(unitTangent, v2t)

  const newVelocity1 = Vector2.Add(newVelocityNormal1, newVelocityTangent1)
  const newVelocity2 = Vector2.Add(newVelocityNormal2, newVelocityTangent2)

  console.log(newVelocity1, newVelocity2)
...
function adjustPhysicsVelocity(gob1, gob2) {
  ...
  // next, project the velocity vectors onto normal and tangential components
...
export function movingSAT(gob1, gob2) {
  ...
  if (TFirst !== 0) {
    ...
    adjustPhysicsVelocityNoTrig(gob1, gob2, normal)
