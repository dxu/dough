...
export function movingSAT(gob1, gob2) {
  ...
  if (TFirst === 0) {
    ...
    gob1.position.y = gob1._previousPosition.y
    gob1.position.x = gob1._previousPosition.x
    ...
    gob1.position.y = gob1._previousPosition.y + gob1.velocity.y * (TFirst - 0.05) * Time.dts
    gob1.position.x = gob1._previousPosition.x + gob1.velocity.x * (TFirst - 0.05) * Time.dts
  }
